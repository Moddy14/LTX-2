...
def basic_arg_parser(
    ...
    parser.add_argument(
        ...
        action="store_true",
        help=(
            "Enhance the prompt before generation. A Gemma 3 encode root is reused; "
            "other encode models require --prompt-enhancer-gemma-root."
        ),
    )
    parser.add_argument(
    ...
    parser.add_argument(
        "--disable-tiling",
        action="store_true",
        help="Disable tiled VAE encoding and decoding for small runs or diagnostics.",
    )
