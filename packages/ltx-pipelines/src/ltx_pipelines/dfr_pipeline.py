...
class DFRPipeline:
    ...
    def __call__(  # noqa: PLR0912, PLR0913, PLR0915, PLR0917
        self,
        prompt: str,
        seed: int,
        height: int,
        ...
        playback_fps = output_frame_rate(frame_rate, temporal_upscalings)
...
def main() -> None:
    ...
    encode_video(
        video=result.video,
        fps=output_frame_rate(args.frame_rate, args.temporal_upscalings),
        audio=result.audio,
