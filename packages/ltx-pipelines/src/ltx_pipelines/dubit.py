...
class DubItPipeline:
    ...
    def __call__(  # noqa: PLR0913
        ...
        decoded_video = self.video_decoder(video_state.latent, tiling_config, stage_2_generator, dtype=vae_dtype)
...
def main() -> None:
    ...
    parser = dubit_arg_parser(params=params, distilled=not official_comfy_hq)
    ...
    if official_comfy_hq and len(args.distilled_lora) != 1:
        raise ValueError("The official Comfy HQ Dub-It profile requires exactly one --distilled-lora.")
