...
class LTXVGemmaTokenizer(LTXGemmaTokenizer):
    """Backward-compatible Gemma-3 tokenizer loader for existing callers."""

    def __init__(self, gemma_root: str, max_length: int = 256):
