...
| --- | --- | --- | --- |
| Implementierungsbasis | Der Engineering-Stand enthält den vollständigen R0–F0-Vertrag und nun auch den fail-closed Q2-Assembler. Die AV-Evaluator-Suite besteht 152/152, Studio 601/601 Tests; Lint und Build sind grün | gut, aber noch kein Release | P0 |
