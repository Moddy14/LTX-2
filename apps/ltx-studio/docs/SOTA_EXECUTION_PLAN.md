...
| Video-Benchmark | Der offizielle VBench-I2V-Commit `45e79ec1…` und 17 relevante Source-/Config-Dateien sind durch einen fail-closed Source-Contract gebunden und gegen einen vollständig sauberen offiziellen Checkout verifiziert; jede weitere tracked oder untracked Datei sperrt den Lauf. Die sechs releasebezogenen Custom-Input-Dimensionen werden einzeln ausgewertet, nie als Gesamtscore. Isolierter Dependency-/Checkpoint-Runtime-Fingerprint und reale Messungen fehlen noch | Source-Vertrag gut; D1-Runtime und Evidenz offen | P2 |
