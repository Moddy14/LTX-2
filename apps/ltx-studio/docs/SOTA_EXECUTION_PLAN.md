...
| --- | --- | --- | --- |
| Implementierungsbasis | Der Engineering-Stand enthält den vollständigen R0–F0-Vertrag und nun auch den fail-closed Q2-Assembler. Die AV-Evaluator-Suite besteht 152/152, Studio 607/607 Tests; Lint und Build sind grün | gut, aber noch kein Release | P0 |
...
| Produktionsworkflow | Der persistente Projektkern speichert Shots, Request-Revisionen, konkrete Continuity-/Retake-Quellen sowie Output-, Sidecar- und Export-Digests in einer owner-only, monotonen Hashkette. Stale Writes, Kettenlücken und verdeckte Mutationen werden CPU-getestet abgewiesen | Backend-Vertrag gut; API-/UI- und Job-Bindung offen | P1 |
