...
| --- | --- | --- | --- |
| Implementierungsbasis | Der Engineering-Stand enthält den vollständigen R0–F0-Vertrag und nun auch den fail-closed Q2-Assembler. Die AV-Evaluator-Suite besteht 152/152, Studio 610/610 Tests; Lint und Build sind grün | gut, aber noch kein Release | P0 |
...
| Produktionsworkflow | Der persistente Projektkern speichert Shots, Request-Revisionen, konkrete Continuity-/Retake-Quellen sowie Output-, Sidecar- und Export-Digests in einer owner-only, monotonen Hashkette. Die API erfasst Actor, Output- und Sidecar-Evidenz serverseitig; Stale Writes, Kettenlücken, Legacy-Provenienz und verdeckte Mutationen werden abgewiesen. Ein isolierter HTTP-Smoke besteht | Backend/API gut; UI- und Job-Startbindung offen | P1 |
